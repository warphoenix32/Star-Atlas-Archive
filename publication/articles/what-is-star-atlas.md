...
Star Atlas takes place in the **Galia Expanse**, a region shaped by migration, industry, belief and war. Three major powers dominate much of its political history:

- **Manus Ultima Divina**, or MUD, is the principal human faction, born from humanity’s escape from a dying Earth.
- The **ONI Consortium** is a coalition of distinct peoples whose alliance was forged through exile and wartime necessity.
- The **Ustur** are an organic-synthetic people and a factional civilization whose history begins with an unexplained awakening.
...
The Galactic Marketplace provided a place to discover and trade assets. SCORE, also known through the Faction Fleet surface, introduced ship enlistment, resource consumption and ATLAS rewards. SAGE Labs opened a browser-based strategy experience built around fleets, mining, crafting and transport. Starbased later expanded that world with shared faction infrastructure and a revised economic model.

The Unreal Engine Showroom offered a different kind of encounter: ships and environments rendered as a high-fidelity, explorable space. Holosim developed as a browser-accessible fleet simulation. Other experiments and test environments, including Escape Velocity and the C4 Public Test Realm, explored narrower mechanics at particular stages of development.
...
Star Atlas also has a real-world institutional structure.

**ATMTA, Inc.** develops and publishes Star Atlas products. The **Star Atlas DAO** is the POLIS-holder governance body. The **Star Atlas Foundation** is described in the governance framework as a legal and administrative implementation body. The elected **Star Atlas Council** supports proposal authors and performs delegated governance and program-administration work.

These roles overlap without becoming identical. The Council is not a sovereign legislature. The Foundation is not the whole DAO. ATMTA’s product plans are not automatically DAO commitments. A passed proposal can authorize work or funding without establishing payment, execution or successful results.

For most visitors, governance is one part of the story rather than the entrance to it. Its importance lies in showing how a player community tried to build durable institutions around a changing game ecosystem.

## The people who made the project a place

Years before every planned system existed, players were already creating the social world around Star Atlas.

Guilds and DACs formed identities, trained members, built tools and imagined future economic roles. Aephia published newsletters, guides and dashboards. Hologram News Network reported on people, events and community institutions. Town Halls and Atlas Brew gave the project a spoken rhythm. Competitions such as COPA turned guild identity into public performance.
