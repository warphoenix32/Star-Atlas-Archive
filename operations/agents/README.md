...
The [Shared Operating Contract](SHARED-OPERATING-CONTRACT.md) applies to every role. On-demand specialists and their activation boundaries are defined in the [Specialist Registry](SPECIALIST-REGISTRY.md).
