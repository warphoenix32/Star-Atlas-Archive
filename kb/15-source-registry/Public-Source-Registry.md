...
This registry records source families discovered during the initial public sweep. Each source should later receive an individual record with capture date, author, completeness, archival status and the claims it supports.

## Official project sources

| Source ID | Source | Function | Reliability notes |
|---|---|---|---|
| SRC-OFF-WEBSITE | https://staratlas.com/ | Current public positioning, products, economy and community links | Strong for current official claims; not a historical archive |
